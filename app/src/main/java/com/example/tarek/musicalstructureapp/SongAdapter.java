...
public class SongAdapter extends ArrayAdapter<Song> {
    ...
    public View getView (int position , View convertView , ViewGroup parent){
        ...
        if(listItemView == null) {
            ...
            TextView songName = (TextView) listItemView.findViewById(R.id.id_song_name_list_item);
            songName.setText(currentSong.getSongName());
            TextView authorName = (TextView) listItemView.findViewById(R.id.id_author_name_list_item);
            authorName.setText(currentSong.getAuthorName());
        }
